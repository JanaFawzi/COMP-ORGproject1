...
setTimeout(function () {
    ...
    if (!elements.disassemblyText.innerHTML.includes("0x0020") ||
        !elements.disassemblyText.innerHTML.includes("B bge")) {
        throw new Error("RAM-style disassembly was not shown.");
    }
